#!/usr/bin/env python3
"""
Vercel Serverless Function for LayanSociety API
This file serves as the entry point for all API endpoints.
"""
...
from backend.tunisia_inflation_calculator import calculate_inflation, INFLATION_RATES
from backend.tunisia_future_cost_estimator import estimate_future_cost, ENVIRONMENTAL_SURCHARGES
from backend.tunisia_economic_indicators import (
...
async def calculate_inflation_endpoint(request: InflationRequest):
    ...
    try:
        ...
        if request.additional_costs:
            from backend.tunisia_inflation_calculator import _total_adjusted_additional_costs
